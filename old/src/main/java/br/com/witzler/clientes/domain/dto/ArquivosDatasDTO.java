...
public class ArquivosDatasDTO {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ArquivosDatasDTO other = (ArquivosDatasDTO) obj;
		if (caminho == null) {
	...
	public String toString() {
		return "ArquivosDatasDTO [data_referencia=" + data_referencia + ", tipo_arquivo=" + tipo_arquivo + ", caminho="
				+ caminho + ", tipo_arquivo_descricao=" + tipo_arquivo_descricao + "]";
	}
