...
public class ArquivosTipoDTO {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ArquivosTipoDTO other = (ArquivosTipoDTO) obj;
		if (caminho == null) {
	...
	public String toString() {
		return "ArquivosTipoDTO [data_referencia=" + data_referencia + ", tipo_arquivo=" + tipo_arquivo + ", caminho="
