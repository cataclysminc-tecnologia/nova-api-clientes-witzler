...
public class MedidasDTO {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MedidasDTO other = (MedidasDTO) obj;
	...
	public String toString() {
		return "MedidasDTO [id_medidas=" + id_medidas + ", ativo_c=" + ativo_c + ", reativo_c=" + reativo_c
				+ ", ativo_g=" + ativo_g + ", reativo_g=" + reativo_g + ", dia_da_semana=" + dia_da_semana
				+ ", data_medicao=" + data_medicao + ", hora_do_dia=" + hora_do_dia + ", unidade_id=" + unidade_id
				+ ", tipo_medida=" + tipo_medida + ", status=" + status + "]";
	}
